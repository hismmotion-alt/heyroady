...
duration: "1.25 hrs"
stopsCount: 4
stopNames: ["Golden Gate Bridge", "Sonoma Plaza", "Yountville", "Napa Downtown"]
stops:
  - name: "Golden Gate Bridge"
    description: "Walk or bike the bridge, stop at Vista Point for the classic Bay view"
    duration: "30 min"
  - name: "Sonoma Plaza"
    description: "Largest town square in California, wine tasting rooms, farmers market"
    duration: "1.5 hrs"
  - name: "Yountville"
    description: "Thomas Keller restaurant row, Michelin stars per capita world record"
    duration: "1 hr"
  - name: "Napa Downtown"
    description: "Oxbow Market, wine bars, riverfront walk and art installations"
    duration: "1.5 hrs"
tags: ["Wine", "Scenic", "Food", "Culture"]
heroImage: "https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=1200&q=80"
instagramReel: "https://www.instagram.com/reel/DKs95_jxTe2/"
...
metaKeywords: ["San Francisco to Napa road trip", "Wine Country drive", "SF to Napa Valley", "Golden Gate to wine country", "California wine country road trip", "weekend road trips California"]
---
...
<HiddenGems gems={[
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1518834107812-67b0b7c58434?w=200&q=80"
  }
]} />
...
<RouteSummary
  ...
  stops={[
    ...
    { name: "Sonoma Plaza", description: "A slight detour off the main route — historic Mexican-era plaza surrounded by tasting rooms and the Sonoma Mission.", duration: "45 min" },
